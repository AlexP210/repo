...
from repo.environments.local_dm_control_suite import base
from repo.environments.local_dm_control_suite import common
...
class Hopper(base.Task):
  ...
  def get_reward(self, physics):
    ...
    standing = rewards.tolerance(physics.height(), 
